    ...
    function videoBg($window, $q, $timeout) {
        return {
            ...
            link: function(scope, element) {
                ...
                var computedStyles,
                    ytScript = document.querySelector('script[src="http://www.youtube.com/iframe_api"]'),
                    ...
                    backgroundImage = scope.mobileImage || 'http://img.youtube.com/vi/' + scope.videoId + '/maxresdefault.jpg',
                    videoArr,
                    videoTimeout;
                ...
                function playerStateChange(evt) {
                    ...
                    if (evt.data === YT.PlayerState.UNSTARTED && scope.playlist) {
                        ...
                        backgroundImage = videoObj.mobileImage || scope.mobileImage || 'http://img.youtube.com/vi/' + videoObj.videoId + '/maxresdefault.jpg';
                ...
                scope.$watch('videoId', function(current, old) {
                    if (current && old && current !== old) {
                        clearTimeout(videoTimeout);
                        backgroundImage = scope.mobileImage || 'http://img.youtube.com/vi/' + current + '/maxresdefault.jpg';
                        setBackgroundImage(backgroundImage);
                        $player.css('display', 'none');
